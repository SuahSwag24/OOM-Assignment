<?php
    ...
    if($_SESSION['confirmedBooking'] !== null)
    {
        ...
        {
            if($s->GetTable()->GetSeat())
            {
                $seatNumber = $s->GetTable()->GetSeat();

                echo "
                        <script>
                            var isDisabled = document.getElementById('t" . $seatNumber . "').disabled;
                            if (isDisabled) {
                                document.getElementById('negus').style.backgroundColor = 'red';
                            }
                        </script>
                    ";
            }
        ...
        <div class="right">
            ...
            <div class="right1">
                <div class="seat4">
                    ...
                    <label class="checkbox-alias" for="labelt1" id="negus"><br><br><br><br>T1</label>
